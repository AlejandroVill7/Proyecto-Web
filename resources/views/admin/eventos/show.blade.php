                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div class="pt-2">
                                <a href="{{ route('admin.eventos.edit', $evento) }}"
                                    class="flex items-center justify-center w-full py-2.5 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-xl text-sm font-bold hover:opacity-90 transition shadow-lg">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
