<x-guest-layout>
    {{-- Contenedor Principal con posición relativa para ubicar el botón --}}
    <div class="flex flex-col md:flex-row h-full overflow-hidden bg-white dark:bg-gray-800 rounded-3xl shadow-2xl max-w-5xl mx-auto border border-gray-100 dark:border-gray-700 relative">
        
        {{-- BOTÓN TOGGLE TEMA (Ubicado en la esquina superior derecha de la tarjeta) --}}
        <button id="theme-toggle-login" type="button" class="absolute top-4 right-4 z-50 p-2 rounded-full text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500">
            <svg id="theme-toggle-dark-icon-login" class="hidden w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path></svg>
            <svg id="theme-toggle-light-icon-login" class="hidden w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" fill-rule="evenodd" clip-rule="evenodd"></path></svg>
        </button>

        {{-- SECCIÓN VISUAL (Izquierda) --}}
        <div class="hidden md:flex md:w-1/2 bg-gradient-to-br from-indigo-600 to-purple-700 p-12 flex-col justify-between text-white relative overflow-hidden">
            ...
            <div class="relative z-10">
                <h1 class="text-4xl font-extrabold tracking-tight">GesPro</h1>
                <p class="mt-2 text-indigo-100 opacity-90">Gestión de Proyectos Académicos</p>
            </div>
        ...
        <div class="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
            ...
            <div class="text-center md:text-left mb-8">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-2">Por favor, introduce tus credenciales.</p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div x-data="{ show: false }">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600 dark:hover:text-gray-200">
                            ...
                            <svg x-show="show" style="display: none;" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a10.059 10.059 0 013.949-5.347m1.735-1.277L21 21m0 0l-1.735-1.277M10.723 8.723a3 3 0 014.554 4.554" /></svg>
                        </button>
                    </div>
                ...
                <div class="block">
                    <label for="remember_me" class="inline-flex items-center">
                        <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:bg-gray-900 dark:border-gray-700 dark:focus:ring-offset-gray-800" name="remember">
                        <span class="ml-2 text-sm text-gray-600 dark:text-gray-400">{{ __('Mantener sesión iniciada') }}</span>
                    </label>
                </div>

                <div class="pt-2">
                    <button type="submit" class="w-full py-3 px-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold shadow-lg hover:shadow-indigo-500/30 transition duration-200 transform hover:-translate-y-0.5">
                        {{ __('Ingresar') }}
                    </button>
                </div>
                ...
                <div class="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <a href="{{ route('register') }}" class="font-bold text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 transition-colors">
                        Regístrate aquí
                    </a>
                </div>
            </form>
