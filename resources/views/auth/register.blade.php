<x-guest-layout>
    ...
    <div class="flex flex-col md:flex-row h-full overflow-hidden bg-white dark:bg-gray-800 rounded-3xl shadow-2xl max-w-5xl mx-auto border border-gray-100 dark:border-gray-700 relative">
        ...
        <button id="theme-toggle-register" type="button" class="absolute top-4 right-4 z-50 p-2 rounded-full text-white/80 hover:text-white md:text-gray-500 md:hover:bg-gray-100 md:dark:text-gray-400 md:dark:hover:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500">
            <svg id="theme-toggle-dark-icon-reg" class="hidden w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path></svg>
            <svg id="theme-toggle-light-icon-reg" class="hidden w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" fill-rule="evenodd" clip-rule="evenodd"></path></svg>
        </button>
        ...
        <div class="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center order-2 md:order-1">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div class="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
                    ¿Ya tienes cuenta? 
                    <a href="{{ route('login') }}" class="font-bold text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 transition-colors">
                        Inicia Sesión
                    </a>
                </div>
            </form>
        ...
        <div class="hidden md:flex md:w-1/2 bg-gradient-to-bl from-purple-700 to-indigo-600 p-12 flex-col justify-center text-white relative order-1 md:order-2 overflow-hidden">
            <div class="absolute top-0 left-0 -ml-10 -mt-10 w-40 h-40 bg-white opacity-10 rounded-full blur-2xl"></div>
            <div class="absolute bottom-0 right-0 -mr-10 -mb-10 w-60 h-60 bg-white opacity-10 rounded-full blur-3xl"></div>
            ...
            <div class="relative z-10 text-center">
                ...
                <p class="text-indigo-100 text-lg leading-relaxed mb-8">
                    Crea tu perfil para registrar equipos, subir proyectos y participar en los mejores eventos académicos.
                </p>
            </div>
        </div>
